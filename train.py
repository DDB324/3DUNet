...
def train(model, train_loader, optimizer, loss_func, n_labels, alpha, device):
    ...
    val_log = OrderedDict({'Train_Loss': train_loss.avg, 'Train_dice_liver': tarin_dice.avg[1]})
    if n_labes == 3:
...
if __name__ == '__main__':
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train_log = train(model, train_loader, optimizer, loss, args.n_labels, alpha, device)
